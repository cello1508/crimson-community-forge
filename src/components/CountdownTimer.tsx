...
const CountdownTimer = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-pink-500 to-pink-600 text-white py-4 shadow-md">
      <div className={`container flex ${isMobile ? 'flex-col' : 'flex-row'} items-center justify-center max-w-5xl gap-4`}>
        ...
        <Badge 
          variant="outline" 
          className="bg-white/20 backdrop-blur-sm px-5 py-3 rounded-md border border-white/30 shadow-inner text-white font-mono"
        >
